...
<img src="C:\Users\Lenovo\AppData\Roaming\Typora\typora-user-images\image-20260213181229322.png" alt="Architecture Overview" style="zoom: 67%;" />
...
RoPE (Rotary Positional Embedding): 旋转位置嵌入，目前最流行的位置编码方式，支持外推。
...
<img src="C:\Users\Lenovo\AppData\Roaming\Typora\typora-user-images\image-20260213181646156.png" alt="Training Process" style="zoom: 50%;" />
...
统计语料库中相邻 Token 对出现的频率。

循环合并出现频率最高的 Token 对，形成新的 Token。

稀有序列将由多个较短的 Token 表示。
...
<img src="C:\Users\Lenovo\AppData\Roaming\Typora\typora-user-images\image-20260213214312879.png" alt="BPE Example" style="zoom:80%;" />